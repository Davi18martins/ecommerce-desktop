...
public class TelaGerenciamentoProdutosController implements Initializable {
    ...
    @FXML
    private TableColumn<Produto, String> colNomeCarro;

    @FXML
    private TableColumn<Produto, String> colModeloCarro;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // TODO
        colNomeCarro.setCellValueFactory(new PropertyValueFactory<>("Nome"));
        colModeloCarro.setCellValueFactory(new PropertyValueFactory<>("Categoria"));
    ...
    @FXML
    private void editarProduto() throws Exception{
